...
def pwmout(lst):
       ...
       for i in range(len(lst)):
              timelist.append(round(float(lst[i][0]),3))
              voltlist.append(round(float(lst[i][1])/4*20.408,1))
       #print("time : ",timelist)
       #print("volt : ",voltlist)
...
def testfunction(fmi_version,
    ...
    input=np.genfromtxt("/home/pi/Downloads/Downloads/FMU_File/fmpytest/input.csv",delimiter=",",names=True)
    #print(input.dtype)
